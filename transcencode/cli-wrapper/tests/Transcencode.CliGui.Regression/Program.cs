...
if (failures > 0)
{
    Console.Error.WriteLine($"TRANSCENCODE_CLI_REGRESSION_TESTS_FAILED: {failures}");
    return 1;
}

Console.WriteLine("TRANSCENCODE_CLI_REGRESSION_TESTS_PASSED");
return 0;
